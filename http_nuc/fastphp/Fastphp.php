...
class Fastphp
{
    ...
    public function route()
    {
		...
		// 原作者的方法，但$param只传递过去$param[0];
		// call_user_func_array(array($dispatch, $actionName), $param);  // 只传过去$param[0]
		//以下方法均可行
        call_user_func(array($dispatch, $actionName), $param); // 会传过去一个数组
		//$dispatch->$actionName($param);   // 此方法会有string -> array 的notice
    }
